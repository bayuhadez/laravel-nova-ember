...
export default class AxxMasterWarehousesEditController extends Controller {
    ...
    breadcrumbs = {
        ...
        subNav: [
            {
                name: this.intl.t('warehouse.heading.edit'),
            }
        ],
    };
            ...
            return new Promise((resolve, reject) => {
                ...
                self.get('warehouse').save().then((warehouse) => {
                    ...
                    Promise.all(
                        ...
                        resolve(warehouse);
                        self.qswal.edit().s();
                        self.transitionToRoute('axx.master.warehouses.index');
                    }).catch((response) => {
                        KTApp.unblockPage();
                        self.qswal.edit().e();
                        reject(response);
