...
export default class AxxMasterUsersAddController extends Controller {
    // services
    @service store;
    @service intl;
    ...
    breadcrumbs = {
        ...
        subNav: [
            {
                name: this.intl.t('user.heading.add'),
            }
        ],
    };
    ...
    saveUserForm(event) {
        ...
        return this
            ...
            .then(() => {
                KTApp.unblockPage();
                qswal.s();
                this.transitionToRoute('axx.master.users.edit', this.get('user.id'));
            })
            .catch((response) => {
                KTApp.unblockPage();
