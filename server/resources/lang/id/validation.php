...
return [
    /*
     | NOTE: after copy from new replace
     | maskimal => maksimal
     | kilobytes => kilobytes
     */
    ...
    */
    ...
    'strong_password' => ':attribute harus memiliki huruf capital (A-Z), huruf kecil (a-z), digit (0-9) dan symbol',
    ...
    */
    ...
    'attributes' => [
        ...
        'phone' => 'Phone',
        'phone.country-id' => 'Negara',
        'phone.number' => 'Nomor',
        'pic' => 'PIC',
        'pic-name' => 'Nama PIC',
        'pobox' => 'PO BOX',
        'request-order-products' => 'Produk',
        'telephone-number' => 'Telephone',
        'telephone.country-id' => 'Negara',
        'telephone.number' => 'Nomor',
        'term-of-payment' => 'TOP',
        'username' => 'Username',
    ],
];
