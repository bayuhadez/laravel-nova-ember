...
<head>
	...
	<title>{{ session('company')->name ?? Nova::name() }}</title>
            ...
            <div class="content">
                ...
                <div data-testid="content" class="px-view py-view mx-auto">
                    ...
                    <p class="mt-8 text-center text-xs text-80">
						<a href="{{ Nova::path() }}" class="text-primary dim no-underline">
							{{ session('company')->name ?? null }} &copy; {{ date('Y') }}
						</a>
						{{--
                        <a href="http://nova.laravel.com" class="text-primary dim no-underline">{{ session('company')->name ?? null }}</a>
